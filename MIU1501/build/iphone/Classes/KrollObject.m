...
//@interface MIU1501Object : NSObject
//@end

@interface MIU1501Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU1501Object class]])
		{
			for (NSString *key in [[(MIU1501Object*)o modules] allKeys])
			{
