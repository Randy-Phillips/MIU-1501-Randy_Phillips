...
// in simulator we redefine to format for MIU1501 Developer console
...
{\
	NSString * exceptionName = [@"org.miu1501." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu1501";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU1501NativeItemNone = -1, 
	UIMIU1501NativeItemSpinner = -2,
	UIMIU1501NativeItemProgressBar = -3,
	
	UIMIU1501NativeItemSlider = -4,
	UIMIU1501NativeItemSwitch = -5,
	UIMIU1501NativeItemMultiButton = -6,
	UIMIU1501NativeItemSegmented = -7,
	
	UIMIU1501NativeItemTextView = -8,
	UIMIU1501NativeItemTextField = -9,
	UIMIU1501NativeItemSearchBar = -10,
	
	UIMIU1501NativeItemPicker = -11,
	UIMIU1501NativeItemDatePicker = -12,
	
	UIMIU1501NativeItemInfoLight = -13,
	UIMIU1501NativeItemInfoDark = -14,
	
	UIMIU1501NativeItemDisclosure = -15,
	
	UIMIU1501NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU1501 instances of
